[assembly: SilverlightActivator.ApplicationStartupMethod(typeof(sdkMicrophoneCS.App_Start.StorageInitializer), "ApplicationStartup", Order = 10)]

namespace sdkMicrophoneCS.App_Start
{
    using System;
